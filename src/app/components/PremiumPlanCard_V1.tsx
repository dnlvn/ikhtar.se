  ...
  return (
    ...
    >
      ...
      >
        ...
        {activePromotion && (
          <div className="absolute left-1/2 top-[62px] z-10 -translate-x-1/2 text-[9px] font-bold leading-none" dir="rtl">
            <span className="inline-flex flex-col items-center whitespace-nowrap rounded-full border border-emerald-200 bg-emerald-50 px-2 py-1 text-emerald-700 shadow-sm">
              <span className="text-[8px] font-semibold">الآن</span>
              <span>100 GB إضافية</span>
            </span>
          </div>
        )}
