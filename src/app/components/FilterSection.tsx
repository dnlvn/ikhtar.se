...
const sortChips: Array<{ value: SortOption; label: string; ariaLabel: string; ltr?: boolean }> = [
  { value: 'best-deals', label: 'أفضل العروض الآن', ariaLabel: 'أفضل العروض الآن' },
  { value: 'yearly-cost', label: 'الأرخص خلال سنة', ariaLabel: 'الأرخص خلال سنة' },
  { value: 'heavy-data', label: 'أكثر من 20 GB', ariaLabel: 'أكثر من 20 GB إنترنت' },
          ...
          {sortChips.map((chip) => {
            ...
            return (
              <button
                ...
                className={`min-h-[34px] rounded-full border px-3 py-1.5 text-[11px] font-black leading-tight transition-all ${
                  isActive
