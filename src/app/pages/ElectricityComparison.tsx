      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div id="electricity-comparison-disclosure" className="rounded-[22px] bg-white p-5 shadow-sm ring-1 ring-blue-100">
          ...
          <p className="text-[13px] leading-6 text-slate-700">
            Ikhtar.se خدمة مقارنة تجارية تقارن مجموعة مختارة من شركات الكهرباء في السويد. قد نحصل على تعويض عندما تنتقل إلى إحدى الشركات أو تبدّل عقدك عبر روابطنا. وقد تؤثر علاقاتنا التجارية على العروض التي تظهر وترتيبها. نعرض الأسعار والتكاليف التقديرية لمساعدتك على مقارنة العروض التي تشملها الخدمة.
          </p>
        </div>
