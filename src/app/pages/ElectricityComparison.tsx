...
const electricityFaqItems = [
  {
    ...
    answer: 'يعتمد أرخص عقد على الرمز البريدي، والاستهلاك، ونوع العقد والرسوم. يقارن Ikhtar.se مجموعة مختارة من شركات الكهرباء ويعرض التكاليف التقديرية للعروض الموجودة في المقارنة.',
  },
  {
  ...
  },
  {
    ...
    answer: 'يختلف مقدار التوفير بحسب استهلاكك وعقدك الحالي والأسعار المتاحة. لذلك من الأفضل مقارنة الأسعار والرسوم والشروط قبل التبديل.',
  },
  {
    question: 'هل السعر المتغير أم الثابت أرخص؟',
    answer: 'يعتمد ذلك على الأسعار الحالية واستهلاكك ومدى رغبتك في الاستقرار أو المرونة. السعر المتغير قد يكون مناسباً للبعض، بينما يفضّل آخرون السعر الثابت لتوقع التكلفة بشكل أوضح.',
  },
  {
...
export function ElectricityComparison() {
  ...
  return (
    <>
      <Helmet>
        <title>قارن عقود الكهرباء في السويد واعثر على خيار أرخص | Ikhtar.se</title>
        <meta
          name="description"
          content="قارن عقود الكهرباء من مجموعة مختارة من شركات الكهرباء في السويد. أدخل الرمز البريدي والاستهلاك وقارن الأسعار والتكاليف التقديرية."
        />
        ...
        {!canSearch && (
          <div className="text-center py-12 px-4">
            <h2 className="text-2xl font-bold text-slate-900 mb-2">
              أدخل الرمز البريدي لعرض العقود المتاحة
            </h2>
...
function ElectricitySeoSection() {
        const agreementTypeCards = [
    {
      ...
      text: 'يتبع سعر الكهرباء المتغير سوق الكهرباء ويمكن أن يتغير من شهر إلى آخر. قد يكون هذا الخيار مناسباً لمن يريد مرونة أكبر ويتقبّل تغيّر السعر بين الأشهر.',
    },
    {
  ...
  const cheapElectricityCards = [
    ['عقود الكهرباء الرخيصة', 'نساعدك على مقارنة عقود كهرباء أرخص من مجموعة مختارة من الشركات في السويد.'],
    ['الكهرباء الرخيصة في السويد', 'قارن الأسعار الحالية بين العروض الموجودة في خدمتنا واعثر على خيار يناسب منزلك واستهلاكك.'],
    ['سعر الكهرباء المتغير', 'قارن عقود الكهرباء ذات السعر المتغير بين العروض الموجودة في خدمتنا.'],
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-blue-100">
          <h2 className="mb-3 text-2xl font-black leading-tight text-slate-950">
            قارن عقود الكهرباء واعثر على خيار أرخص
          </h2>
          <div className="space-y-3 text-[14px] leading-7 text-slate-700">
            <p>هنا يمكنك مقارنة عقود الكهرباء من مجموعة مختارة من شركات الكهرباء في السويد. نعرض الأسعار والتكاليف التقديرية بناءً على الرمز البريدي واستهلاكك للكهرباء لمساعدتك على مقارنة العروض التي تشملها خدمتنا.</p>
            <p>قد تساعدك مقارنة عقود الكهرباء بانتظام على اكتشاف خيارات أرخص أو شروط أنسب من عقدك الحالي.</p>
            <p>يتم تحديث الأسعار والشروط بانتظام لعرض معلومات حديثة عن العروض الموجودة في مقارنة Ikhtar.se.</p>
          </div>
        </div>
        ...
        <div className="rounded-[24px] bg-blue-950 p-5 text-white shadow-lg shadow-blue-950/10">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            {[
              ['1', 'أدخل الرمز البريدي والاستهلاك', 'أدخل الرمز البريدي وحدد كمية الكهرباء التي تستخدمها تقريباً سنوياً لعرض العقود الموجودة في مقارنتنا والمتاحة في منطقتك.'],
              ['2', 'قارن عقود الكهرباء', 'قارن الأسعار والرسوم والشروط بين العروض الموجودة في مقارنتنا.'],
              ['3', 'اختر العقد المناسب', 'عندما تجد عقداً يناسبك، يمكنك الانتقال إلى شركة الكهرباء لقراءة الشروط وإكمال عملية التبديل لدى المزود.'],
        ...
        <SeoTextBlock title="لماذا يدفع كثيرون مبالغ مرتفعة للكهرباء؟">
          ...
          <p>قد يكون الفرق في التكلفة ملحوظاً بين العقود المختلفة، لذلك من المفيد مقارنة الأسعار والرسوم والشروط بشكل منتظم.</p>
        ...
        <div className="rounded-[22px] bg-blue-50 p-5 ring-1 ring-blue-100">
          <h2 className="mb-2 text-lg font-black text-blue-950">حول المقارنة وروابطنا</h2>
          <p className="text-[13px] leading-6 text-blue-900">
            يقارن Ikhtar.se مجموعة مختارة من شركات الكهرباء والعقود. قد نحصل على تعويض عندما تنتقل إلى شركة كهرباء أو تبدّل عقدك عبر روابطنا. وقد تؤثر علاقاتنا التجارية على العروض التي تظهر وترتيبها. لا يؤثر ذلك على السعر الذي تدفعه لدى شركة الكهرباء.
          </p>
        </div>

        <div id="electricity-comparison-disclosure" className="rounded-[22px] bg-white p-5 shadow-sm ring-1 ring-blue-100">
          <h2 className="mb-2 text-lg font-black text-slate-950">كيف تعمل مقارنتنا</h2>
          <div className="space-y-3 text-[13px] leading-6 text-slate-700">
            <p>يقارن Ikhtar.se مجموعة مختارة من عقود الكهرباء التي تقدمها شركات نتعاون معها. نعطي الأولوية لبعض شركات الكهرباء بناءً على عدة عوامل، من بينها مدى ملاءمة عروضها لمستخدمينا وعلاقاتنا التجارية معها. لذلك، قد يؤثر التعويض الذي نحصل عليه من شركات الكهرباء على العروض التي تظهر وعلى العروض التي تحصل على ترتيب أكثر بروزًا.</p>
            <p>من بين العروض التي نعطيها الأولوية، يتم ترتيب العقود حسب السعر بناءً على التكلفة التقديرية وفقًا لرمزك البريدي واستهلاكك السنوي للكهرباء.</p>
            <p>قد نحصل على تعويض عندما تنتقل إلى شركة كهرباء أو تشترك في عقد عبر روابطنا. ولا يؤثر ذلك على السعر الذي تدفعه لدى شركة الكهرباء.</p>
            <p>يقارن Ikhtar.se مجموعة مختارة من شركات وعقود الكهرباء، ولا تشمل المقارنة جميع الشركات أو جميع عقود الكهرباء المتاحة في السوق السويدية.</p>
          </div>
        </div>
        ...
        <div className="rounded-[26px] bg-gradient-to-br from-blue-700 to-blue-950 p-6 text-center text-white shadow-xl shadow-blue-900/20">
          <h2 className="mb-2 text-2xl font-black">قارن عقود الكهرباء اليوم</h2>
          <p className="mx-auto mb-5 max-w-2xl text-[14px] leading-7 text-blue-50">
            قارن عروض الكهرباء من مجموعة مختارة من شركات الكهرباء السويدية وشاهد الخيارات المتاحة حسب الرمز البريدي والاستهلاك.
          </p>
          <button
            type="button"
